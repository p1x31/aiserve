...
setup(
    ...
    packages=['', 'venv.lib.python2.7.distutils', 'venv.lib.python2.7.encodings',
              ...
              'venv.lib.python2.7.site-packages.pip._internal.operations', 'venv.lib.python2.7.site-packages.click',
              'venv.lib.python2.7.site-packages.flask', 'venv.lib.python2.7.site-packages.flask.json',
              'venv.lib.python2.7.site-packages.wheel', 'venv.lib.python2.7.site-packages.wheel.cli',
              'venv.lib.python2.7.site-packages.jinja2', 'venv.lib.python2.7.site-packages.werkzeug',
              ...
              'venv.lib.python2.7.site-packages.setuptools.command', 'venv.lib.python2.7.site-packages.itsdangerous',
